...
class NotificationReadAdpter(var context: Context, var arrayList: ArrayList<NotificationResponse.Read>, var clickListener: ClickListener, ) : RecyclerView.Adapter<NotificationReadAdpter.ViewHolder>() {
