...
class HomeActivityNew : BaseActivity(), OnMenuOpenListener,OnSideMenuSelectListener {
    ...
    private fun setUpMenus(){
        ...
        menuList.add(SideMenuModel(R.drawable.ic_myorder_sidemenu,resources.getString(R.string.MyOrders),false))
        menuList.add(SideMenuModel(R.drawable.ic_bookvenu_sidemenu,resources.getString(R.string.BookedVenue),false))
