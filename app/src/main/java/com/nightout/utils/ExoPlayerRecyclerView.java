...
public class ExoPlayerRecyclerView extends RecyclerView {
     ...
     */
    // Media List
    private ArrayList<VenuDetailModel.VenueGallery> mediaObjects = new ArrayList<>();
    ...
    public void setMediaObjects(ArrayList<VenuDetailModel.VenueGallery> mediaObjects) {
