...
class DelEmngyPhNoViewModel (activity: Activity) : BaseObservable() {
    ...
    fun delEmngcy(map:HashMap<String,String>): LiveData<Resource<BaseModel>> {
        dashboardModel = webServiceRepository.delEmergency(map)
